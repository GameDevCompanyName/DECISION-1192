package TextGameOld.igorlo;

import TextGameOld.igorlo.Elements.Dislocation;
import TextGameOld.igorlo.Elements.Interactable;
import TextGameOld.igorlo.Elements.NotPlayableCharacter;
import TextGameOld.igorlo.Elements.Player;
import game.Logic.Stranger;
import game.groups.MainGame.GameInterface;

import java.io.InputStream;
import java.util.List;
import java.util.Scanner;

import static TextGameOld.igorlo.Config.*;
...
public class InteractiveConsole {
    ...
    public final ChoiceGetter pray = new ChoiceGetter(gameInterface);
    ...
    public InteractiveConsole(GameInterface gameInterface){
    ...
    private void say(String wordOfGod){
        gameInterface.appendText(wordOfGod);
    }
    ...
    private static void sleep(int time){
        try {
            Thread.currentThread().sleep((int) (time / GAME_SPEED));
    ...
    public class ChoiceGetter {
        ...
        String choice = null;
        InputStream inputStream = gameInterface.getStream();

        public ChoiceGetter(GameInterface gameInterface) {
